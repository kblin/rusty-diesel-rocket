...
COMMENT ON TABLE bgc_types IS
  'Biosynthetic gene cluster types.';

--- basic MIBiG types
INSERT INTO bgc_types (term, name, description, parent_id, safe_class)
...
LEFT JOIN bgc_types f ON val.parent_term = f.term;
